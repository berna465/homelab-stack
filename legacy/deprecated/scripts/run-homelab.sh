...
BUILD_TEMPLATE_SCRIPT="${REPO_ROOT}/infra/proxmox/scripts/build_template.sh"
PROVISION_SCRIPT="${REPO_ROOT}/scripts/provision-vms.sh"
STACK_SCRIPT="${REPO_ROOT}/infra/proxmox/scripts/stack.sh"
DESTROY_SCRIPT="${REPO_ROOT}/infra/proxmox/scripts/destroy_homelab.sh"
